...
<head>
    ...
    <style data-href="{{ asset('/styles.c7ccc0e53fa291e4a376.css') }}" id="gatsby-global-css"></style>
    <meta name="generator" content="Gatsby 2.32.13">

    <title>@yield('page-title')</title>

    <meta data-react-helmet="true" name="description" content="">
    <meta data-react-helmet="true" property="og:title" content="Homepage">
    <meta data-react-helmet="true" property="og:description" content="">
    <meta data-react-helmet="true" property="og:type" content="website">
    <meta data-react-helmet="true" name="twitter:card" content="summary">
    <meta data-react-helmet="true" name="twitter:creator" content="@local">
    <meta data-react-helmet="true" name="twitter:title" content="Homepage">
    ...
    <link rel="icon" href="{{ asset('/favicon/favicon-32x32.png') }}?v=57e4ad3d5795e1155c18e993a85e47b0"
          type="image/png">
    ...
    <link as="script" rel="preload" href="{{ asset('/script-files//styles-29147cbc04bbc833f6a0.js') }}">
    <link as="script" rel="preload" href="{{ asset('/script-files/commons-bc79a17391b8a8fff16f.js') }}">
    <link as="script" rel="preload" href="{{ asset('/script-files/063ff8727a94ecc32b0164bb756a6d8ff2e98efd-3872849f610c8c4ec30e.js') }}">
    <link as="script" rel="preload" href="{{ asset('/script-files/154d62c19bc02fa2523dce1dc89e2fa605d9aeeb-b2059a1cbfdec4bbd8f4.js') }}">
    <link as="script" rel="preload" href="{{ asset('/script-files/8b75eecd8f2198f35ab7480a62f43106241f8c5d-ec99d8159c0e5fa8299b.js') }}">
    <link as="script" rel="preload" href="{{ asset('/script-files/component---src-templates-homepage-js-4752940f2c4dc62cef41.js') }}">
    <link as="fetch" rel="preload" href="{{ asset('/page-data/index/page-data.json') }}" crossorigin="anonymous">
    <link as="fetch" rel="preload" href="{{ asset('/page-data/sq/d/1296785774.json') }}" crossorigin="anonymous">
    <link as="fetch" rel="preload" href="{{ asset('/page-data/sq/d/2238259800.json') }}" crossorigin="anonymous">
    <link as="fetch" rel="preload" href="{{ asset('/page-data/sq/d/2997433256.json') }}" crossorigin="anonymous">
    <link as="fetch" rel="preload" href="{{ asset('/page-data/sq/d/63159454.json') }}" crossorigin="anonymous">
    <link as="fetch" rel="preload" href="{{ asset('/page-data/sq/d/886364674.json') }}" crossorigin="anonymous">
    <link as="fetch" rel="preload" href="{{ asset('/page-data\app-data.json') }}" crossorigin="anonymous">
    <link rel="prefetch" href="{{ asset('/page-data/contact/page-data.json') }}" crossorigin="anonymous" as="fetch">
    <link rel="prefetch" href="{{ asset('/page-data/culture/page-data.json') }}" crossorigin="anonymous" as="fetch">
    ...
    <link rel="prefetch" href="{{ asset('/script-files/component---src-templates-digital-assets-js-e1381ff23a5f481dd217.js') }}">
    <script charset="utf-8" src="{{ asset('/script-files/component---src-templates-about-us-js-aa62385c1585798a19f5.js') }}"></script>
</head>
<body>
<div id="___gatsby">
    <div style="" tabindex="-1" id="gatsby-focus-wrapper">
        <div class="preloader">
            <svg width="266" height="16" viewBox="0 0 266 16" fill="none">
                <path
...
@php
    ...
    if ('/' !== $_currentPath):
        $_currentPath = '/'.trim($_currentPath, '/').'/';
    endif;
@endphp
<script id="gatsby-script-loader">
    /*<![CDATA[*/
    window.pagePath = "{{ $_currentPath }}";
    /*]]>*/
</script>
...
<script src="{{ asset('/script-files//polyfill-9799aaa91727104e950c.js') }}" nomodule=""></script>
<script src="{{ asset('/script-files/component---src-templates-homepage-js-4752940f2c4dc62cef41.js') }}" async=""></script>
<script src="{{ asset('/script-files/8b75eecd8f2198f35ab7480a62f43106241f8c5d-ec99d8159c0e5fa8299b.js') }}" async=""></script>
<script src="{{ asset('/script-files//154d62c19bc02fa2523dce1dc89e2fa605d9aeeb-b2059a1cbfdec4bbd8f4.js') }}" async=""></script>
<script src="{{ asset('/script-files/063ff8727a94ecc32b0164bb756a6d8ff2e98efd-3872849f610c8c4ec30e.js') }}" async=""></script>
<script src="{{ asset('/script-files/commons-bc79a17391b8a8fff16f.js') }}" async=""></script>
<script src="{{ asset('/script-files/styles-29147cbc04bbc833f6a0.js') }}" async=""></script>
<script src="{{ asset('/script-files//app-a7cd4ccdf2dc35faf047.js') }}" async=""></script>
<script src="{{ asset('/script-files/framework-4edb921af83d1c3c3bd1.js') }}" async=""></script>
<script src="{{ asset('/script-files/webpack-runtime-0019eabbd235cdabd30c.js') }}" async=""></script>
</body>
</html>
